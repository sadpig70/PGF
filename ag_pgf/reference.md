...
> **Core PPR syntax** (AI_, AI_make_, →, [parallel], data types, flow control) is defined in the **PG skill**.
> **Convergence Loop**, **Failure Strategy**, and **acceptance_criteria concepts** also belong to PG.
> This document describes only the **framework-specific extensions** that PGF adds on top of PG.
...
> The concept definition of acceptance_criteria (3 types: functional/qualitative/structural) is in the PG skill reference.
> This section additionally describes the **writing principles** for PGF execution.
...
3. **Specific**: Eliminate ambiguous expressions, specify with numbers/conditions
